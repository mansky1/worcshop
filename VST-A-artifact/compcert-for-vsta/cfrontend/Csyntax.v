...
Inductive partial_statement : Type :=
  | PSlbrace : partial_statement
  | PSrbrace : partial_statement
  | PSstmt : statement -> partial_statement
  | PSif : expr -> partial_statement (**r if (b) **)
  | PSelse : partial_statement
  | PScom : comment -> partial_statement
  | PSwhile : expr -> partial_statement (**r while(b) **)
  | PSfor : option expr -> option expr -> option expr -> partial_statement
  | PSdecl : list (ident * type) -> partial_statement.
