...
Inductive partial_statement :=
 | PLBRACE : partial_statement
 | PRBRACE : partial_statement
 | PIF : expression -> loc -> partial_statement
 | PELSE : partial_statement
 | PWHILE : expression -> loc -> partial_statement
 | PFOR : option expression -> option expression -> option expression -> loc -> partial_statement
 | PDECL : definition -> partial_statement
 | PCOM : comment -> partial_statement
 | PSTMT : statement -> partial_statement.
