...
%type<Cabs.partial_statement> partial_statement
%type<Cabs.partial_statement> translation_ps

%start<Cabs.partial_statement> translation_ps_file
%%
...
translation_ps_file:
| ps = translation_ps EOF
    { ps }

translation_ps:
| ps = partial_statement
    { ps }
...
| RBRACE
    { Cabs.PRBRACE }
| loc = IF_ LPAREN exp = expression RPAREN
    { Cabs.PIF (fst exp) loc }
| ELSE
    { Cabs.PELSE }
| loc = WHILE LPAREN exp = expression RPAREN
    { Cabs.PWHILE (fst exp) loc }
| loc = FOR LPAREN expr1 = expression SEMICOLON expr2 = expression SEMICOLON expr3 = expression RPAREN
    { Cabs.PFOR (Some (fst expr1)) (Some (fst expr2)) (Some (fst expr3)) loc }
| loc = FOR LPAREN SEMICOLON expr2 = expression SEMICOLON expr3 = expression RPAREN
    { Cabs.PFOR None (Some (fst expr2)) (Some (fst expr3)) loc }
| loc = FOR LPAREN expr1 = expression SEMICOLON SEMICOLON expr3 = expression RPAREN
    { Cabs.PFOR (Some (fst expr1)) None (Some (fst expr3)) loc }
| loc = FOR LPAREN SEMICOLON SEMICOLON expr3 = expression RPAREN
    { Cabs.PFOR None None (Some (fst expr3)) loc }
| loc = FOR LPAREN expr1 = expression SEMICOLON expr2 = expression SEMICOLON RPAREN
    { Cabs.PFOR (Some (fst expr1)) (Some (fst expr2)) None loc }
| loc = FOR LPAREN SEMICOLON expr2 = expression SEMICOLON RPAREN
    { Cabs.PFOR None (Some (fst expr2)) None loc }
| loc = FOR LPAREN expr1 = expression SEMICOLON SEMICOLON RPAREN
    { Cabs.PFOR (Some (fst expr1)) None None loc }
| loc = FOR LPAREN SEMICOLON SEMICOLON RPAREN
    { Cabs.PFOR None None None loc }
| d = declaration
    { Cabs.PDECL d }
| com = COMMENT
    { Cabs.PCOM (fst com) }
