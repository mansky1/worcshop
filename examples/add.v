...
Definition _slow_add : ident := $"slow_add".
...
(Ssequence
  (Swhile
    ...
    (Ssequence
      ...
      (Sset _y
        (Ebinop Oadd (Etempvar _y tint) (Econst_int (Int.repr 1) tint) tint))))
...
((___compcert_va_int32,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_add, Gfun(Internal f_add)) :: (_slow_add, Gfun(Internal f_slow_add)) ::
 nil).

Definition public_idents : list ident :=
(_slow_add :: _add :: ___builtin_debug :: ___builtin_write32_reversed ::
